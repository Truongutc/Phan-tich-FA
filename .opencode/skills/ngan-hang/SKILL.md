...
## 19. TÍNH TOÁN CHỈ SỐ THEO TỪNG QUÝ (QUARTERLY RATIOS)
...
2. **LDR Quý**: `LDR_q = Cho vay khách hàng (bsb103) / (Tiền gửi khách hàng (bsb113) + Giấy tờ có giá (bsb116))`.
3. **CASA Quý**: `CASA_q = Tiền gửi không kỳ hạn (bsb114) / Tiền gửi khách hàng (bsb113)`.
4. **NPL Quý**: `NPL_q = Nợ xấu (bsb105) / Cho vay khách hàng (bsb103)`.
5. Đóng gói mảng chỉ số quý này vào trường `ratios_quarterly` trong file JSON Summary để Dashboard đọc tĩnh.
